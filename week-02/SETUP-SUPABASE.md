...
| 項目 | 狀態 |
|------|------|
| Week 02 專案 scaffold | 已完成（`week-02/todo-saas`） |
| Supabase schema SQL | 已準備（`todo-saas/supabase/schema.sql`） |
...
貼上 `week-02/todo-saas/supabase/schema.sql` 的全部內容 → **Run**
...
1. Push `week-02/` 到 GitHub
2. Vercel 專案 **Root Directory** 設 `week-02/todo-saas`
